...
using demoproject.DataAccess.Repository;
...
builder.Services.AddDbContext<DepartmentDbcontext>(Options => Options.UseSqlServer(builder.Configuration.GetConnectionString("Constr")));
